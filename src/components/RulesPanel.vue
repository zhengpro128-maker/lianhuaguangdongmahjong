...
const rules = computed(() => {
  if (props.variant === 'wuhan-huanghuang') return [
    ...
    ['特殊胡法', '门前清按 6 分起算，但必须自摸或抢杠胡才成立；支持全求人、杠上开花和抢杠胡。将一色、风一色、见字胡不计大胡；弃牌响应采用单响截胡。'],
    ['计分', '自摸屁胡从 3 分起算，杠番继续翻倍；自摸大胡在大胡牌型分上 ×1.5。点炮时三家均付款，放炮者在基础应付分上 ×2，其他两家不翻倍。硬胡 ×2；红中杠、直杠、补杠 ×2，暗杠和癞子杠 ×4；每名付款者最多支付 50 分。'],
    ['荒庄', '牌墙剩余 8 张时停止摸牌并荒庄。'],
  ]
