    ...
    <div class="lobby-layout" :class="{ 'room-focused': Boolean(roomId) }">
      ...
      <section class="lobby-actions" aria-label="对局操作">
        ...
        <div class="lobby-links">
          ...
          <a class="repository-link" data-action-role="light" href="https://github.com/zhengpro128-maker/lianhuaguangdongmahjong" target="_blank" rel="noopener noreferrer" aria-label="在 GitHub 新标签页打开项目仓库">
